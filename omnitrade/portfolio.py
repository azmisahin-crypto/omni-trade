...
class Portfolio:
    ...
    def check_risk_exits(self, last_prices: dict[str, float]) -> None:
        ...
        for symbol in list(self.positions.keys()):
            ...
            if self.risk.should_stop_loss(pos.entry_price, price):
                self._close_position(symbol, price, reason="stop-loss tetiklendi")
            elif self.risk.should_take_profit(pos.entry_price, price):
                self._close_position(symbol, price, reason="take-profit tetiklendi")
